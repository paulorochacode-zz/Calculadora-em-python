...
class Calc(object):
    def __init__(self, parent=tk.Tk()):
        ...
        self.bt_sair = tk.Button(self.parent, text="Sair(Esc)",command=lambda:self.parent.destroy())
    ...
    def about(self):
        ...
        tk.Label(about_window, text="Calculadora",font=("Verdana",15,"bold")).grid(row=0,column=0,padx=5,pady=5,sticky="s")
        ...
        tk.Label(about_window, text="paulorocha7117@gmail.com").grid(row=3,column=0,sticky="s",padx=5)
